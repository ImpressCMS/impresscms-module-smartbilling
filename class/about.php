...
class SmartcontentAbout
{
	...
	function SmartcontentAbout($aboutTitle='About')
	{
		...
		$this->_lang_author_info = _MI_SBILLING_AUTHOR_INFO;
		$this->_lang_developer_lead = _MI_SBILLING_DEVELOPER_LEAD;
		$this->_lang_developer_contributor = _MI_SBILLING_DEVELOPER_CONTRIBUTOR;
		$this->_lang_developer_website = _MI_SBILLING_DEVELOPER_WEBSITE;
		$this->_lang_developer_email = _MI_SBILLING_DEVELOPER_EMAIL;
		$this->_lang_developer_credits = _MI_SBILLING_DEVELOPER_CREDITS;
		$this->_lang_module_info = _MI_SBILLING_MODULE_INFO;
		$this->_lang_module_status = _MI_SBILLING_MODULE_STATUS;
		$this->_lang_module_release_date =_MI_SBILLING_MODULE_RELEASE_DATE ;
		$this->_lang_module_demo = _MI_SBILLING_MODULE_DEMO;
		$this->_lang_module_support = _MI_SBILLING_MODULE_SUPPORT;
		$this->_lang_module_bug = _MI_SBILLING_MODULE_BUG;
		$this->_lang_module_submit_bug = _MI_SBILLING_MODULE_SUBMIT_BUG;
		$this->_lang_module_feature = _MI_SBILLING_MODULE_FEATURE;
		$this->_lang_module_submit_feature = _MI_SBILLING_MODULE_SUBMIT_FEATURE;
		$this->_lang_module_disclaimer = _MI_SBILLING_MODULE_DISCLAIMER;
		$this->_lang_author_word = _MI_SBILLING_AUTHOR_WORD;
		$this->_lang_version_history = _MI_SBILLING_VERSION_HISTORY;
		$this->_lang_by = _MI_SBILLING_BY;
	}
	...
	function render()
	{
	    ...
	    $filename = SMARTBILLING_ROOT_PATH . "changelog.txt";
	    if(is_file($filename)){
