...
function smartbilling_notify_iteminfo($category, $item_id)
{
    ...
    if ($category == 'item') {
        ...
        $sql = 'SELECT question FROM ' . $xoopsDB->prefix('smartbilling_partner') . ' WHERE id = ' . $item_id;
